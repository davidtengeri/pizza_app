    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `profile` (`id` INTEGER, `name` TEXT, `phone` TEXT, `email` TEXT, PRIMARY KEY (`id`))');
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Address` (`id` INTEGER, `city` TEXT NOT NULL, `street` TEXT NOT NULL, `houseNumber` TEXT NOT NULL, PRIMARY KEY (`id`))');
